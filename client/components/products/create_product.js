...
export default class CreateProduct extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = props.product? props.product:{body: '', title: '',description: '', body: '', startPrice: 10, minimumPrice: 3, currentPrice: 10, priceFunction: '', startDate: new Date(), endingDate: new Date()};
